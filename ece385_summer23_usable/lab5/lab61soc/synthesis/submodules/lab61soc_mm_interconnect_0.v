...
module lab61soc_mm_interconnect_0 (
		...
		input  wire        clk_1_c0_clk,                                   //                                 clk_1_c0.clk
		...
		output wire [1:0]  clk_1_pll_slave_address,                        //                          clk_1_pll_slave.address
		output wire        clk_1_pll_slave_write,                          //                                         .write
		output wire        clk_1_pll_slave_read,                           //                                         .read
		input  wire [31:0] clk_1_pll_slave_readdata,                       //                                         .readdata
		output wire [31:0] clk_1_pll_slave_writedata,                      //                                         .writedata
	...
	wire   [31:0] clk_1_pll_slave_agent_m0_readdata;                                                  // clk_1_pll_slave_translator:uav_readdata -> clk_1_pll_slave_agent:m0_readdata
	wire          clk_1_pll_slave_agent_m0_waitrequest;                                               // clk_1_pll_slave_translator:uav_waitrequest -> clk_1_pll_slave_agent:m0_waitrequest
	wire          clk_1_pll_slave_agent_m0_debugaccess;                                               // clk_1_pll_slave_agent:m0_debugaccess -> clk_1_pll_slave_translator:uav_debugaccess
	wire   [27:0] clk_1_pll_slave_agent_m0_address;                                                   // clk_1_pll_slave_agent:m0_address -> clk_1_pll_slave_translator:uav_address
	wire    [3:0] clk_1_pll_slave_agent_m0_byteenable;                                                // clk_1_pll_slave_agent:m0_byteenable -> clk_1_pll_slave_translator:uav_byteenable
	wire          clk_1_pll_slave_agent_m0_read;                                                      // clk_1_pll_slave_agent:m0_read -> clk_1_pll_slave_translator:uav_read
	wire          clk_1_pll_slave_agent_m0_readdatavalid;                                             // clk_1_pll_slave_translator:uav_readdatavalid -> clk_1_pll_slave_agent:m0_readdatavalid
	wire          clk_1_pll_slave_agent_m0_lock;                                                      // clk_1_pll_slave_agent:m0_lock -> clk_1_pll_slave_translator:uav_lock
	wire   [31:0] clk_1_pll_slave_agent_m0_writedata;                                                 // clk_1_pll_slave_agent:m0_writedata -> clk_1_pll_slave_translator:uav_writedata
	wire          clk_1_pll_slave_agent_m0_write;                                                     // clk_1_pll_slave_agent:m0_write -> clk_1_pll_slave_translator:uav_write
	wire    [2:0] clk_1_pll_slave_agent_m0_burstcount;                                                // clk_1_pll_slave_agent:m0_burstcount -> clk_1_pll_slave_translator:uav_burstcount
	wire          clk_1_pll_slave_agent_rf_source_valid;                                              // clk_1_pll_slave_agent:rf_source_valid -> clk_1_pll_slave_agent_rsp_fifo:in_valid
	wire  [104:0] clk_1_pll_slave_agent_rf_source_data;                                               // clk_1_pll_slave_agent:rf_source_data -> clk_1_pll_slave_agent_rsp_fifo:in_data
	wire          clk_1_pll_slave_agent_rf_source_ready;                                              // clk_1_pll_slave_agent_rsp_fifo:in_ready -> clk_1_pll_slave_agent:rf_source_ready
	wire          clk_1_pll_slave_agent_rf_source_startofpacket;                                      // clk_1_pll_slave_agent:rf_source_startofpacket -> clk_1_pll_slave_agent_rsp_fifo:in_startofpacket
	wire          clk_1_pll_slave_agent_rf_source_endofpacket;                                        // clk_1_pll_slave_agent:rf_source_endofpacket -> clk_1_pll_slave_agent_rsp_fifo:in_endofpacket
	wire          clk_1_pll_slave_agent_rsp_fifo_out_valid;                                           // clk_1_pll_slave_agent_rsp_fifo:out_valid -> clk_1_pll_slave_agent:rf_sink_valid
	wire  [104:0] clk_1_pll_slave_agent_rsp_fifo_out_data;                                            // clk_1_pll_slave_agent_rsp_fifo:out_data -> clk_1_pll_slave_agent:rf_sink_data
	wire          clk_1_pll_slave_agent_rsp_fifo_out_ready;                                           // clk_1_pll_slave_agent:rf_sink_ready -> clk_1_pll_slave_agent_rsp_fifo:out_ready
	wire          clk_1_pll_slave_agent_rsp_fifo_out_startofpacket;                                   // clk_1_pll_slave_agent_rsp_fifo:out_startofpacket -> clk_1_pll_slave_agent:rf_sink_startofpacket
	wire          clk_1_pll_slave_agent_rsp_fifo_out_endofpacket;                                     // clk_1_pll_slave_agent_rsp_fifo:out_endofpacket -> clk_1_pll_slave_agent:rf_sink_endofpacket
	wire          cmd_mux_002_src_valid;                                                              // cmd_mux_002:src_valid -> clk_1_pll_slave_agent:cp_valid
	wire  [103:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> clk_1_pll_slave_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                              // clk_1_pll_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [5:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> clk_1_pll_slave_agent:cp_channel
	wire          cmd_mux_002_src_startofpacket;                                                      // cmd_mux_002:src_startofpacket -> clk_1_pll_slave_agent:cp_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                                        // cmd_mux_002:src_endofpacket -> clk_1_pll_slave_agent:cp_endofpacket
	...
	wire          clk_1_pll_slave_agent_rp_valid;                                                     // clk_1_pll_slave_agent:rp_valid -> router_004:sink_valid
	wire  [103:0] clk_1_pll_slave_agent_rp_data;                                                      // clk_1_pll_slave_agent:rp_data -> router_004:sink_data
	wire          clk_1_pll_slave_agent_rp_ready;                                                     // router_004:sink_ready -> clk_1_pll_slave_agent:rp_ready
	wire          clk_1_pll_slave_agent_rp_startofpacket;                                             // clk_1_pll_slave_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          clk_1_pll_slave_agent_rp_endofpacket;                                               // clk_1_pll_slave_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire          clk_1_pll_slave_agent_rdata_fifo_src_valid;                                         // clk_1_pll_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] clk_1_pll_slave_agent_rdata_fifo_src_data;                                          // clk_1_pll_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire          clk_1_pll_slave_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_002:in_0_ready -> clk_1_pll_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_002_out_0_valid;                                                  // avalon_st_adapter_002:out_0_valid -> clk_1_pll_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                                   // avalon_st_adapter_002:out_0_data -> clk_1_pll_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                                  // clk_1_pll_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                                  // avalon_st_adapter_002:out_0_error -> clk_1_pll_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) clk_1_pll_slave_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (clk_1_pll_slave_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (clk_1_pll_slave_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (clk_1_pll_slave_agent_m0_read),                  //                         .read
		.uav_write              (clk_1_pll_slave_agent_m0_write),                 //                         .write
		.uav_waitrequest        (clk_1_pll_slave_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (clk_1_pll_slave_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (clk_1_pll_slave_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (clk_1_pll_slave_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (clk_1_pll_slave_agent_m0_writedata),             //                         .writedata
		.uav_lock               (clk_1_pll_slave_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (clk_1_pll_slave_agent_m0_debugaccess),           //                         .debugaccess
		.av_address             (clk_1_pll_slave_address),                        //      avalon_anti_slave_0.address
		.av_write               (clk_1_pll_slave_write),                          //                         .write
		.av_read                (clk_1_pll_slave_read),                           //                         .read
		.av_readdata            (clk_1_pll_slave_readdata),                       //                         .readdata
		.av_writedata           (clk_1_pll_slave_writedata),                      //                         .writedata
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
		.av_byteenable          (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) clk_1_pll_slave_agent (
		.clk                     (clk_0_clk_clk),                                    //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
		.m0_address              (clk_1_pll_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (clk_1_pll_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (clk_1_pll_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (clk_1_pll_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (clk_1_pll_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (clk_1_pll_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (clk_1_pll_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (clk_1_pll_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (clk_1_pll_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (clk_1_pll_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (clk_1_pll_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (clk_1_pll_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (clk_1_pll_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (clk_1_pll_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (clk_1_pll_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (clk_1_pll_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (clk_1_pll_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (clk_1_pll_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (clk_1_pll_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (clk_1_pll_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (clk_1_pll_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (clk_1_pll_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (clk_1_pll_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (clk_1_pll_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (clk_1_pll_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (clk_1_pll_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_002_out_0_ready),                // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_002_out_0_valid),                //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_002_out_0_data),                 //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_002_out_0_error),                //                .error
		.rdata_fifo_src_ready    (clk_1_pll_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (clk_1_pll_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (clk_1_pll_slave_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                            //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                              //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) clk_1_pll_slave_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                    //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (clk_1_pll_slave_agent_rf_source_data),             //        in.data
		.in_valid          (clk_1_pll_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (clk_1_pll_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (clk_1_pll_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (clk_1_pll_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (clk_1_pll_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (clk_1_pll_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (clk_1_pll_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (clk_1_pll_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (clk_1_pll_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	lab61soc_mm_interconnect_0_router_002 router_004 (
		.sink_ready         (clk_1_pll_slave_agent_rp_ready),                 //      sink.ready
		.sink_valid         (clk_1_pll_slave_agent_rp_valid),                 //          .valid
		.sink_data          (clk_1_pll_slave_agent_rp_data),                  //          .data
		.sink_startofpacket (clk_1_pll_slave_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (clk_1_pll_slave_agent_rp_endofpacket),           //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_clk           (clk_1_c0_clk),                                   //       out_clk.clk
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_clk            (clk_1_c0_clk),                                   //        in_clk.clk
	...
	lab61soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (clk_1_pll_slave_agent_rdata_fifo_src_data),      //     in_0.data
		.in_0_valid     (clk_1_pll_slave_agent_rdata_fifo_src_valid),     //         .valid
		.in_0_ready     (clk_1_pll_slave_agent_rdata_fifo_src_ready),     //         .ready
	...
	lab61soc_mm_interconnect_0_avalon_st_adapter_004 #(
		...
		.in_clk_0_clk   (clk_1_c0_clk),                            // in_clk_0.clk
